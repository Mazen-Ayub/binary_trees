 ...
 * @n: an integer stored in node
 * @parent: a pointer to  parent node
 * @left: a pointer tp left child node
 * @right: a pointer to right child node
 */
...
/**
 * struct avl_data_s - a function that combined recrusive height & AVL balance
 * @height: the height of a subtree
...
/* output formatted to match project examples */
